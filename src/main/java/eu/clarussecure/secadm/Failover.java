...
public class Failover extends Command {
    ...
    public CommandReturn execute() throws CommandExecutionException {
        ...
        if (!success) {
            retValue = 3;
            retMessage = "There was an error trying to " + (this.enabledFailover ? "enable" : "disable")
                    + " the Failover mode";
        }
    ...
    public boolean parseCommandArgs(String[] args) throws CommandParserException {
        ...
        if (!args[0].toLowerCase().equals("failover"))
            throw new CommandParserException(
                    "Why a non-'failover' command ended up in the 'failover' part of the parser?");
        ...
        try {
            ...
            if (param.equals("true") || param.equals("enabled") || param.equals("1") || param.equals("enable")
                    || param.equals("on") || param.equals("yes"))
