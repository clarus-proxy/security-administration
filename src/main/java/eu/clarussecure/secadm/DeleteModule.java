    ...
    public boolean parseCommandArgs(String[] args) throws CommandParserException {
        ...
        if (!args[0].toLowerCase().equals("delete_module"))
            throw new CommandParserException(
                    "Why a non-'delete_module' command ended up in the 'delete_module' part of the parser?");
        ...
        try {
            ...
            throw new CommandParserException(
                    "There was an error identifying the Module ID. Is the ID number well formed?");
        }
