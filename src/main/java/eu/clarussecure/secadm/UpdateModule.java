    ...
    public CommandReturn execute() throws CommandExecutionException {
        ...
        if (oldVersion < newVersion) {
            ...
            try {
                ...
                cr = new CommandReturn(1,
                        "There was an error transfering the file. The module has not been registered");
    ...
    public boolean parseCommandArgs(String[] args) throws CommandParserException {
        ...
        if (!args[0].toLowerCase().equals("update_module"))
            throw new CommandParserException(
                    "Why a non-'update_module' command ended up in the 'update_module' part of the parser?");
        ...
        try {
            ...
            throw new CommandParserException(
                    "There was an error identifying the CSP ID. Is the ID number well formed?");
        }
